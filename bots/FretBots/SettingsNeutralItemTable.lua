...
local neutral_items =
{
	...
	-- {name="item_rippers_lash",			tier=1,		ranged=1,		melee=1,		roles={1,1,1,1,1},		realName="Ripper's Lash"},  -- cycled out 7.40
	...
	-- {name="item_spark_of_courage",		tier=1,		ranged=1,		melee=1,		roles={1,1,1,1,1},		realName="Spark of Courage"},  -- cycled out 7.40
	...
	-- {name="item_sisters_shroud",			tier=1,		ranged=1,		melee=1,		roles={1,1,1,5,5},		realName="Sister's Shroud"},  -- cycled out 7.40
	...
	{name="item_ash_legion_shield",		tier=1,		ranged=1,		melee=1,		roles={1,1,3,2,2},		realName="Ash Legion Shield"},  -- new 7.40
	{name="item_weighted_dice",			tier=1,		ranged=1,		melee=1,		roles={1,1,1,1,1},		realName="Weighted Dice"},  -- new 7.40
	...
	-- {name="item_misericorde",			tier=2,		ranged=1,		melee=1,		roles={4,2,1,0,0},		realName="Brigand's Blade"},  -- cycled out 7.40
	...
	-- {name="item_defiant_shell",			tier=3,		ranged=1,		melee=2,		roles={2,2,6,2,2},		realName="Defiant Shell"},  -- moved to tier 2
	...
	-- {name="item_gale_guard",			tier=3,		ranged=1,		melee=1,		roles={1,1,4,1,1},		realName="Gale Guard"},  -- cycled out 7.40
	...
	-- {name="item_magnifying_monocle",		tier=4,		ranged=1,		melee=1,		roles={2,2,1,3,3},		realName="Magnifying Monocle"},  -- cycled out 7.40
	...
	-- {name="item_pyrrhic_cloak",		tier=4,		ranged=1,		melee=1,		roles={1,1,4,4,4},		realName="Pyrrhic Cloak"},  -- cycled out 7.40
	{name="item_giant_maul",		tier=4,		ranged=1,		melee=1,		roles={5,5,1,0,0},		realName="Giant's Maul"},
	-- {name="item_outworld_staff",		tier=4,		ranged=1,		melee=1,		roles={1,1,1,1,1},		realName="Outworld Staff"},  -- cycled out 7.40
	{name="item_flayers_bota",		tier=4,		ranged=1,		melee=1,		roles={2,2,1,3,3},		realName="Flayer's Bota"},  -- new 7.40
	{name="item_idol_of_screeauk",	tier=4,		ranged=1,		melee=1,		roles={1,1,3,4,4},		realName="Idol of Scree'Auk"},  -- new 7.40
	{name="item_metamorphic_mandible",	tier=4,		ranged=1,		melee=1,		roles={3,3,2,1,1},		realName="Metamorphic Mandible"},  -- new 7.40
	...
	-- {name="item_unrelenting_eye",				tier=5,		ranged=1,		melee=1,		roles={2,2,2,2,2},		realName="Unrelenting Eye"},  -- moved to tier 3
	-- {name="item_helm_of_the_undying",			tier=5,		ranged=1,		melee=1,		roles={5,5,5,5,5},		realName="Helm of the Undying"},  -- cycled out 7.40
	...
	{name="item_riftshadow_prism",		tier=5,		ranged=1,		melee=1,		roles={1,1,3,3,3},		realName="Riftshadow Prism"},  -- new 7.40
}
